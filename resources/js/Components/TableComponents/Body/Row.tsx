...
export default function Row() {
    return (
        <div className="flex flex-row justify-center items-center w-full p-5 hover:bg-background-light-neutral hover:dark:bg-background-dark-neutral transition-colors duration-150">
            <span className="text-text-light-secondary dark:text-text-dark-secondary w-full text-left text-sm md:text-base cursor-pointer">N°ACD65GF</span>
            <span className="text-text-light-secondary dark:text-text-dark-secondary w-full text-left text-sm md:text-base hidden md:block">08 Apr 2022</span>
            <span className="text-text-light-secondary dark:text-text-dark-secondary w-full text-left text-sm md:text-base hidden md:block">3/4</span>
