...
export default function Step({id, index, text, type, selected, onClick, onChange, onClickStepType, onClickDelete}: { id: string, index: number, text: string, type: number, selected: boolean, onClick: any, onChange: any, onClickStepType: any, onClickDelete: any }) {
