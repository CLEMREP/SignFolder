...
export default forwardRef(function EmailTextInput(
    ...
    return (
        <div className="relative w-full">
            <Icons className={"absolute inset-y-0 my-auto w-12 fill-text-light-disabled dark:fill-text-dark-disabled"} iconName={'email'} size={25} />
            <input
                {...props}
                type={type}
